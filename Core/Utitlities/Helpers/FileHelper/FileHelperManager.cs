...
namespace Core.Utitlities.Helpers.FileHelper
{
    public class FileHelperManager : IFileHelper
    {
        public void Delete(string filePath)//Burada ki string filePath, 'TrainerImageManager'dan gelen dosyamın kaydedildiği adres ve adı 
        {
        ...
        public string GetByName(string filePath)
        {
